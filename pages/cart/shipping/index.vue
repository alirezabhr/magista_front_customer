    ...
    <v-col cols="12" sm="9" md="8" lg="6" class="pa-0">
      <v-card min-height="620" outlined color="grey lighten-4" class="pa-2">
        <v-card v-for="shopCartOrder in getCart" :key="shopCartOrder.shopId" class="pa-2 my-2">
          ...
          <v-card-text v-if="!shopCartOrder.shop.delivery.sendEverywhere && shopCartOrder.shop.city !== getCustomer.city" class="red--text py-0">
          ...
          <div class="my-0 mx-4">
            ...
            >
              <v-row align="center" no-gutters>
                <v-col offset="1" cols="1">
                  <v-card height="16" width="16" rounded="circle" :color="shopCartOrder.deliveryId === shopCartOrder.shop.delivery.nationalPost.id ? '#42A5F5' : ''" elevation="0" style="border: 1px solid #42A5F5;" />
                </v-col>
                <v-col class="justify-start" offset="1" cols="9">
                  <div>پست پیشتاز</div>
                  <div class="text-caption">هزینه حدودی: <span class="font-weight-bold">{{ shopCartOrder.shop.delivery.nationalPost.base }} تومان</span></div>
                </v-col>
              </v-row>
            </v-card>
            <v-card
            ...
            >
              <v-row align="center" no-gutters>
                <v-col offset="1" cols="1">
                  <v-card height="16" width="16" rounded="circle" :color="shopCartOrder.deliveryId === shopCartOrder.shop.delivery.onlineDelivery.id ? '#42A5F5' : ''" elevation="0" style="border: 1px solid #42A5F5;" />
                </v-col>
                <v-col class="justify-start" offset="1" cols="9">
                  <div>پیک آنلاین</div>
                  <div class="text-caption">هزینه حدودی: <span class="font-weight-bold">{{ shopCartOrder.shop.delivery.onlineDelivery.base }} تومان</span></div>
                </v-col>
              </v-row>
            </v-card>
          </div>
